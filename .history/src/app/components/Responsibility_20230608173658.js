export default function Responsibility() {
  return (
    <div className=" relative">
      ...
      />
      <div className=" flex flex-col text-left absolute top-[75%] left-[5%]  translate-y-[-50%] gap-6">
        <h1 className=" text-white font-black text-6xl tracking-wider">
          This is our responsibility
        </h1>
        <p className=" text-white text-lg w-[30rem]">
